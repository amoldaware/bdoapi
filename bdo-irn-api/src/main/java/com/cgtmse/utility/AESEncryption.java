...
public class AESEncryption {
   ...
   public static byte[] decodeBase64StringTOByte(String stringData) throws Exception {
		return java.util.Base64.getDecoder().decode(stringData.getBytes());
	}
    ...
    */
    public static byte[] decrypt(String plainText, byte[] secret)
		...
		System.out.println("Base64.decodeBase64(plainText):"+Base64.decodeBase64(plainText));
...
//			String decrypted_appkey = "OcmZofV8DtvsnpDdjiDbmW/NWu5KPcit5YZ7sY63vRs=";
...
//			String receivedSEK = "sOA9pXy2sq4V9wjG6zE0ib7iStHLxLvA+c3ZPsHFqzb1Ey9CKYFo0OsW/bcRwVSV";
